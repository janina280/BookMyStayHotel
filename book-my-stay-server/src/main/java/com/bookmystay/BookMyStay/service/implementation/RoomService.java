...
import com.bookmystay.BookMyStay.service.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    public Response getAllRooms() {
        ...
        try {
            ...
            List<RoomDTO> roomDTOList = Utils.mapRoomListEntityToRoomDTO(roomList);
    ...
    @Override
    public Response getAvailableRoomsByDataAndType(LocalDate checkInData, LocalDate checkOutData, String roomType) {
        Response response = new Response();
        try {
            List<Room> availableRooms = roomRepository.findAvailableRoomsByDatesAndTypes(checkInData, checkOutData, roomType);
            List<RoomDTO> availableRoomsDTO = Utils.mapRoomListEntityToRoomDTO(availableRooms);
            response.setStatusCode(200);
            response.setMessage("successful");
